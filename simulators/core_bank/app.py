    ...
    if case_query:
        ...
        if credit:
            ...
            <div class="memo-found-record" id="memo_found_box" style="background:#e8f4e8; border:1px solid #4a8; padding:10px; margin-top:10px;">
                ...
                <div>Institution: <strong class="found-institution-id">{html.escape(credit.institution_id)}</strong></div>
                <div>Currency: <strong class="found-currency">{html.escape(credit.currency)}</strong></div>
